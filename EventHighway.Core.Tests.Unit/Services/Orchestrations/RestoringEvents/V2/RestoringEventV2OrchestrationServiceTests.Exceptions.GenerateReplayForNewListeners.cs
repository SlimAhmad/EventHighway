...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.RestoringEvents.V2
{
    public partial class RestoringEventV2OrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnGenerateReplayForNewListenersIfDependencyValidationErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            ValueTask generateReplayTask =
                this.restoringEventV2OrchestrationService.GenerateReplayForNewListenersAsync(
                    someEventArchiveV2s,
        ...
        public async Task ShouldThrowDependencyExceptionOnGenerateReplayForNewListenersIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnGenerateReplayForNewListenersIfTimeoutOccursAndLogItAsync()
        {
            // given
            List<EventArchiveV2> someEventArchiveV2s = CreateRandomEventArchiveV2s();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnGenerateReplayForNewListenersIfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnGenerateReplayForNewListenersAsync()
        {
            // given
            List<EventArchiveV2> someEventArchiveV2s = CreateRandomEventArchiveV2s();
