...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.HealthChecks.V2
{
    public partial class HealthV2CoordinationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveDuplicateDetectionSummaryIfValidationExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveDuplicateDetectionSummaryIfTimeoutOccursAndLogItAsync()
        {
            ...
            ValueTask<DuplicateDetectionSummaryV2> retrieveTask =
                this.healthV2CoordinationService
                    .RetrieveDuplicateDetectionSummaryV2Async(
                        TrafficPeriodV2.Day, GetRandomDateTimeOffset(),
                        TestContext.Current.CancellationToken);
