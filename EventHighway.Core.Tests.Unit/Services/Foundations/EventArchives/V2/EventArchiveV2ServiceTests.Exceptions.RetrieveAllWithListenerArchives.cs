...
namespace EventHighway.Core.Tests.Unit.Services.Foundations.EventArchives.V2
{
    public partial class EventArchiveV2ServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllWithListenersIfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllWithListenersAsync()
        {
            // given
