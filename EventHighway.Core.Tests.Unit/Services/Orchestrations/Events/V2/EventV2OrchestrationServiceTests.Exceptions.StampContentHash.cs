...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.Events.V2
{
    public partial class EventV2OrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnStampContentHashIfValidationExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnStampContentHashIfDependencyExceptionOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnStampContentHashIfExceptionOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnStampContentHashIfTimeoutOccursAndLogItAsync()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnStampContentHashAsync()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
