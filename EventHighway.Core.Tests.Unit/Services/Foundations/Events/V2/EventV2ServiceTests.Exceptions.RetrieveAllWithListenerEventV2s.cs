...
namespace EventHighway.Core.Tests.Unit.Services.Foundations.Events.V2
{
    public partial class EventV2ServiceTests
    {
        [Fact]
        public async Task
            ShouldThrowCriticalDependencyExceptionOnRetrieveAllWithListenerEventV2sIfSqlExceptionOccursAndLogItAsync()
        {
            // given
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectAllEventV2sWithListenerEventV2sAsync(It.IsAny<CancellationToken>()))
                    .ThrowsAsync(sqlException);

            // when
            ValueTask<IQueryable<EventV2>> retrieveAllTask =
                this.eventV2Service.RetrieveAllEventV2sWithListenerEventV2sAsync(randomCancellationToken);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllWithListenerEventV2sIfTimeoutOccursAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask<IQueryable<EventV2>> retrieveAllTask =
                this.eventV2Service.RetrieveAllEventV2sWithListenerEventV2sAsync(
                    TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllWithListenerEventV2sAsync()
        {
            // given
            ...
            // when
            ValueTask<IQueryable<EventV2>> retrieveAllTask =
                this.eventV2Service.RetrieveAllEventV2sWithListenerEventV2sAsync(cancelledToken);
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveAllWithListenerEventV2sIfExceptionOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
