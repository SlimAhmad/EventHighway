...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.Events.V2
{
    public partial class EventV2OrchestrationServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnMarkAsImmediateIfTimeoutOccursAndLogItAsync()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnMarkAsImmediateAsync()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
