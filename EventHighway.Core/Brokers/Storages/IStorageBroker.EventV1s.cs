...
namespace EventHighway.Core.Brokers.Storages
{
    internal partial interface IStorageBroker
    {
        ...
        ValueTask<IQueryable<EventV1>> SelectAllEventV1sAsync(CancellationToken cancellationToken = default);
        ValueTask<IQueryable<EventV1>> SelectAllEventV1sWithListenerEventV1sAsync(CancellationToken cancellationToken = default);
