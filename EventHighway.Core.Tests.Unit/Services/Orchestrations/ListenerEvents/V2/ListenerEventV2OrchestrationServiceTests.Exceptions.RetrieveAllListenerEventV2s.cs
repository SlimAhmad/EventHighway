...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.ListenerEvents.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllListenerEventV2sIfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveAllListenerEventV2sIfValidationErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllListenerEventV2sIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllListenerEventV2sAsync()
        {
            // given
            ...
            ValueTask<IQueryable<ListenerEventV2>> retrieveAllListenerEventV2sTask =
                this.listenerEventV2OrchestrationService
                    .RetrieveAllListenerEventV2sAsync(cancelledToken);
