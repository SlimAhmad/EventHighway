...
namespace EventHighway.Core.Tests.Unit.Services.Processings.Events.V2
{
    public partial class EventV2ProcessingServiceTests
    {
        ...
        public async Task
            ShouldThrowDependencyValidationExceptionOnRetrieveEventV2CountBySignatureIfDependencyValidationErrorOccursAndLogItAsync(
                Xeption validationException)
        {
            ...
            ValueTask<int> retrieveCountTask =
                this.eventV2ProcessingService.RetrieveEventV2CountBySignatureAsync(
                    someEventV2,
        ...
        public async Task
            ShouldThrowDependencyExceptionOnRetrieveEventV2CountBySignatureIfDependencyExceptionOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveEventV2CountBySignatureIfTimeoutOccursAndLogItAsync()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveEventV2CountBySignatureAsync()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveEventV2CountBySignatureIfExceptionOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
