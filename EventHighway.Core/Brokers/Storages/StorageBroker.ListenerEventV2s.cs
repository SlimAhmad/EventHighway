...
namespace EventHighway.Core.Brokers.Storages
{
    internal partial class StorageBroker
    {
        ...
        public async ValueTask<IQueryable<ListenerEventV2>> SelectAllEventV2sWithListenerEventV2Async(
            CancellationToken cancellationToken = default) =>
            (await SelectAllAsync<ListenerEventV2>(cancellationToken))
                .Include(listenerEventV2 => listenerEventV2.EventListenerV2);
        ...
        public async ValueTask<IQueryable<ListenerEventV2>>
            SelectAllListenerEventV2sWithEventV2WithEventListenerV2Async(
                CancellationToken cancellationToken = default) =>
            (await SelectAllAsync<ListenerEventV2>(cancellationToken))
                .Include(listenerEventV2 => listenerEventV2.EventV2)
                .Include(listenerEventV2 => listenerEventV2.EventListenerV2);
    }
}
