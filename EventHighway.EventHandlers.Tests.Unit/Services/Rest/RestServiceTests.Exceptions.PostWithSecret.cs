...
namespace EventHighway.EventHandlers.Tests.Unit.Services.Rest
{
    public partial class RestServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnPostWithSecretIfBadRequestErrorOccursAndLogItAsync()
        {
            // given
            string randomContent = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnPostWithSecretIfHttpErrorOccursAndLogItAsync()
        {
            // given
            string randomContent = GetRandomString();
