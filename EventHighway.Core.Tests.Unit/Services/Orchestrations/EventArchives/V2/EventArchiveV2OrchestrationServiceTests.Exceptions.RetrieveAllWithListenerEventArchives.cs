...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.EventArchives.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllEventArchivesWithListenerEventArchivesIfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task
            ShouldThrowDependencyValidationExceptionOnRetrieveAllEventArchivesWithListenerEventArchivesIfDependencyValidationExceptionOccursAndLogItAsync(
        ...
        public async Task
            ShouldThrowDependencyExceptionOnRetrieveAllEventArchivesWithListenerEventArchivesIfDependencyExceptionOccursAndLogItAsync(
        ...
        [Fact]
        public async Task
            ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllEventArchivesWithListenerEventArchivesAsync()
        {
            // given
