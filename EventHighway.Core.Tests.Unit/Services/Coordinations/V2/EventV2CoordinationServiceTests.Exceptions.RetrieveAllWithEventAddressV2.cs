...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.V2
{
    public partial class EventV2CoordinationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationOnRetrieveAllWithEventAddressV2IfDependencyValidationErrorOccursAndLogItAsync(
            Xeption validationException)
        {
            ...
            ValueTask<IQueryable<EventV2>> retrieveAllTask =
                this.eventV2CoordinationService.RetrieveAllEventV2sWithEventAddressV2Async(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllWithEventAddressV2IfDependencyExceptionOccursAndLogItAsync(
