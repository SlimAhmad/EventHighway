...
namespace EventHighway.Core.Tests.Unit.Clients.ReplayingEvents.V2
{
    public partial class ReplayingEventV2ClientTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnTargetedReplayIfValidationErrorOccursAsync(
            Xeption validationException)
        {
            ...
            ValueTask replayTask =
                this.replayingEventV2Client.ReplayEventArchiveV2sAsync(
                    Guid.NewGuid(), null, null, false, randomCancellationToken);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnTargetedReplayIfDependencyErrorOccursAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnTargetedReplayIfServiceErrorOccursAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnTargetedReplayIfUnexpectedErrorOccursAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
