...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.Events.V2
{
    public partial class EventV2OrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnModifyIfValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnModifyEventV2Async()
        {
            // given
            EventV2 someEventV2 = CreateRandomEventV2();
