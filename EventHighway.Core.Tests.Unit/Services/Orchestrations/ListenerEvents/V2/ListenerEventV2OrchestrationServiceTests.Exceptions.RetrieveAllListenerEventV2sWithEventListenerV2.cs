...
namespace EventHighway.Core.Tests.Unit.Services.Orchestrations.ListenerEvents.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllListenerEventV2sWithEventListenerV2IfTimeoutOccursAndLogItAsync()
        {
            // given
            ...
            this.listenerEventV2ProcessingServiceMock.Setup(service =>
                service.RetrieveAllListenerEventV2sWithEventListenerV2Async(It.IsAny<CancellationToken>()))
                    .ThrowsAsync(operationCanceledException);

            // when
            ValueTask<IQueryable<ListenerEventV2>> retrieveAllListenerEventV2sWithEventListenerV2Task =
            ...
            ListenerEventV2OrchestrationDependencyException
                actualListenerEventV2OrchestrationDependencyException =
                    await Assert.ThrowsAsync<ListenerEventV2OrchestrationDependencyException>(
                        retrieveAllListenerEventV2sWithEventListenerV2Task.AsTask);
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveAllListenerEventV2sWithEventListenerV2IfValidationErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveAllListenerEventV2sWithEventListenerV2IfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveAllListenerEventV2sWithEventListenerV2IfExceptionOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllListenerEventV2sWithEventListenerV2Async()
        {
            // given
            ...
            ValueTask<IQueryable<ListenerEventV2>> retrieveAllListenerEventV2sWithEventListenerV2Task =
                this.listenerEventV2OrchestrationService
                    .RetrieveAllListenerEventV2sWithEventListenerV2Async(cancelledToken);
