...
namespace EventHighway.Core.Tests.Unit.Services.Foundations.ListenerEvents.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowCriticalDependencyExceptionOnRetrieveReplayBatchWithNavigationsIfSqlExceptionOccursAndLogItAsync()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveReplayBatchWithNavigationsIfExceptionOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveReplayBatchWithNavigationsIfTimeoutOccursAndLogItAsync()
        {
            // given
            int randomTake = GetRandomNumber();
        ...
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveReplayBatchWithNavigationsAsync()
        {
            // given
            int randomTake = GetRandomNumber();
