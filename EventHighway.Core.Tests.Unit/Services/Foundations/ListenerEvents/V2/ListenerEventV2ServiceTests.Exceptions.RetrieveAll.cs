    ...
    public partial class ListenerEventV2ServiceTests
    {
        ...
        public async Task ShouldThrowCriticalDependencyExceptionOnRetrieveAllIfSqlExceptionOccursAndLogItAsync()
        {
            ...
            ValueTask<IQueryable<ListenerEventV2>> retrieveAllListenerEventV2sTask =
                this.listenerEventV2Service.RetrieveAllListenerEventV2sAsync(randomCancellationToken);
        ...
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllAsync()
        {
            ...
            // when
            ValueTask<IQueryable<ListenerEventV2>> retrieveAllListenerEventV2sTask =
                this.listenerEventV2Service.RetrieveAllListenerEventV2sAsync(cancelledToken);
