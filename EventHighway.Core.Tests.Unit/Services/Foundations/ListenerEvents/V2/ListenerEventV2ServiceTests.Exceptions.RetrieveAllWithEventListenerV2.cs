    ...
    public partial class ListenerEventV2ServiceTests
    {
        ...
        public async Task ShouldThrowCriticalDependencyExceptionOnRetrieveAllWithEventListenerV2IfSqlExceptionOccursAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectAllEventV2sWithListenerEventV2Async(It.IsAny<CancellationToken>()))
                    .ThrowsAsync(sqlException);

            // when
            ValueTask<IQueryable<ListenerEventV2>> retrieveAllTask =
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveAllWithEventListenerV2IfExceptionOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
